// Đề bài: Có 8 LED được gắn vào PORTB. 
// Viết chương trình để tạo hiệu ứng một bóng LED sáng chạy từ trái sang phải (LED0 → LED7), 
// sau đó ngay lập tức chạy ngược lại từ phải sang trái (LED7 → LED0). Quá trình này lặp lại vô tận.
// Yêu cầu:

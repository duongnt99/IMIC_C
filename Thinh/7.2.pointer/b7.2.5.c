// Bài tập 5: Tìm phần tử trong mảng, trả về con trỏ
// •	Đề bài: Viết một hàm nhận vào một mảng, kích thước của nó, và một giá trị cần tìm. 
// Hàm sẽ trả về một con trỏ tới lần xuất hiện đầu tiên của giá trị đó trong mảng. Nếu không tìm thấy, trả về NULL.
#include<stdio.h>
